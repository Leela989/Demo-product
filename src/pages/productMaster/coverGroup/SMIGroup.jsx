...
import data from "./SMI_Group.json";
...
const SMIGroup = () => {
  ...
  const actionBodyTemplate1 = (rowData, index) => {
    return (
      <div className="kebab-menu-container">
        <Menu model={main_table_options} popup ref={menuRight} id="popup_menu_left" />
        <Button
          text
          rounded
          className="action-menu"
