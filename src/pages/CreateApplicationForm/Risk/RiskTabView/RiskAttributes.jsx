          ...
          <AccordionTab header="Field Attributes">
            ...
            >
              <Column
                ...
                header="Field ID"
                body={(rowData) => (
                  <InputField type="number" value={rowData.FieldID} disabled />
                )}
              />
              <Column
                field="FieldName"
                header="Field Name"
                body={(rowData) => (
                  <InputField type="text" value={rowData.FieldName} disabled />
                )}
              />
              <Column
                field="dataType"
                header="Data Type"
                body={(rowData) => (
                  <InputField type="text" value={rowData.dataType} disabled />
                )}
              />
              <Column
                field="FieldType"
                header="Field Type"
                body={(rowData) => (
                  <InputField type="text" value={rowData.FieldType} disabled />
                )}
              />
              <Column
                field="max-width"
              ...
              <Column
                ...
                header="Serial"
                body={(rowData) => (
                  <InputField type="text" value={rowData.serial} disabled />
                )}
              />
              <Column
                field="Default-value"
